		...
		<view v-if="isHome" class="headNav"
			...
			<view style="flex: 1;">
				<navigator url="../../pages/search/index"
					:style="'height:' + menu.height * 2 + 'rpx;line-height:' + menu.height * 2 + 'rpx;margin-top:' + (menu.top * 2 - status) + 'rpx;margin-left: 32rpx;margin-right:' + (menu.width * 2 + 24) + 'rpx;background-color: #f4f4f4;border-radius: 200rpx;text-align: center;'">
...
console.log(pages.value, '111111111');
//获取胶囊的位置
