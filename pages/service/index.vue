	...
	<view>
			...
			<view class="pub-box-bd">
				<view class="weui-cell weui-cell_input">
					...
					<view class="weui-cell__ft">
						<view class="f5 ic__info" @click="handleTap">服务内容</view>
					</view>
				</view>
			</view>
		</view>
		...
		<block v-if="service.stype == 30 || service.stype == 40">
					...
					<view class="weui-cell weui-cell_input" @click="onAddressChange">
						...
						<view class="weui-cell__ft weui-cell__ft_in-access">
							<input class="weui-input" :disabled="true" style="text-align: right" placeholder-class="vp-placeholder"
								placeholder="请选择收件信息" :value="order.address.userName
			...
			<view class="pub-box">
				...
				<view class="pub-box-bd">
					<view class="weui-cell weui-cell_input">
						<view class="weui-cell__bd">
							<textarea name="demand" auto-height placeholder="如有其他服务要求请在此填写.." placeholder-class="vp-placeholder"
								style="min-height: 150rpx" v-model="order.demand" />
						</view>
					</view>
				</view>
		...
		<uni-popup ref="qrcodePopup" type="center" :is-mask-click="false" background-color="#fff">
			<view class="pay-box">
				...
				<view class="text-center">请用本人微信扫描二维码支付</view>
			</view>
		</uni-popup>
	</view>
</template>
